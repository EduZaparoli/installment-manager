        ...
        <>
            <Container align='center' justifyContent='space-between' navbar theme logo>
                <Flex height={'90vh'} alignItems={'center'} justifyContent={'center'}>
                    <LoginContainer onContinue={onContinue} resetPassword email={email} password={password} newPassword={newPassword} onNewPassword={setNewPassword} onEmail={setEmail} onPassword={setPassword} />
                </Flex>
            </Container>
        </>
    );
